...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-ntp/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-ntp/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-ntp.svg)](https://github.com/buluma/ansible-role-ntp/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-ntp.svg)](https://github.com/buluma/ansible-role-ntp/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-ntp.svg)](https://github.com/buluma/ansible-role-ntp/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/ntp)](https://galaxy.ansible.com/ui/standalone/roles/buluma/ntp/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-ntp/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-ntp/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-ntp
